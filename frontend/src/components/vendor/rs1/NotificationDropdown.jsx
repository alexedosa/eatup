...
import { NOTIFICATIONS } from '@/data/vendorBusiness'
              ...
              {NOTIFICATIONS.map((notif) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-bold text-stone-800 dark:text-white truncate">{notif.title}</p>
                    <p className="text-[11px] text-stone-500 dark:text-stone-400 line-clamp-2 mt-0.5">{notif.message}</p>
                    <p className="text-[9px] text-stone-400 dark:text-stone-500 font-bold uppercase mt-1.5">{notif.time}</p>
                  </div>
                  {!notif.read && (
